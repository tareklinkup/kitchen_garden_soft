...
<div class="content_scroll" style="padding:120px 20px 25px 160px">
    ...
    <table class="border" cellspacing="0" cellpadding="0" width="80%">
        ...
        <h4><a style="cursor:pointer" onclick="window.open('<?php echo base_url();?>Administrator/reports/datewise_cashview_print', 'newwindow', `width=${screen.width}, height=${screen.height}`); return false;"><img src="<?php echo base_url(); ?>images/printer.png" alt=""> Print</a></h4>
        <tr bgcolor="#ccc">
            <th>Account Name</th>
            <th>In Amount</th>                      
            <th>Out Amount</th> 
