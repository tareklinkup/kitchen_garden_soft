...
<div class="content_scroll" style="">
    ...
    <table class="border" cellspacing="0" cellpadding="0" width="80%">
        ...
        <h4><a style="cursor:pointer" onclick="window.open('<?php echo base_url();?>incomePrint', 'newwindow', `width=${screen.width}, height=${screen.height}`); return false;"><i class="fa fa-print" style="font-size:24px;color:green"></i> Print</a></h4>
        ...
        <tr align="center">
            ...
            <td><?php echo $row->Tr_date; ?></td>
             <td>
                <?php 
                    if($row->Tr_Type == 'In Cash'): echo 'Cash Receive'; endif;
                ?>
            </td>
