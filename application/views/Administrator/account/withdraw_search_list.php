...
<div class="content_scroll" style="">
    ...
    <table class="border" cellspacing="0" cellpadding="0" width="80%">
        ...
        <h4><a style="cursor:pointer" onclick="window.open('<?php echo base_url();?>withdrawPrint', 'newwindow', `width=${screen.width}, height=${screen.height}`); return false;"><i class="fa fa-print" style="font-size:24px;color:green"></i> Print</a></h4>
