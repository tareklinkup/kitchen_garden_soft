<div class="col-xs-12">
	<form name="PaymentForm" id="PaymentForm" method="POST">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<?php 
						...
						if($value->Supplier_SlNo == $edit->SPayment_customerID ):
					?>
						<input class="form-control" name="catname" id="catname" type="text" placeholder="Supplier Name" value="<?php echo $value->Supplier_Name; ?>" />
		...
		<div class="col-sm-6">
			...
			<label class="col-sm-1 control-label">:</label>	
				<div class="col-sm-6">
				<input class="form-control date-picker" name="paymentDate" id="paymentDate" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px !important;" value="<?php echo  $edit->SPayment_date; ?>" />
			...
			<div class="form-group">
				...
				<label class="col-sm-1 control-label">:</label>
				<div class="col-sm-6">
					<input type="text" id="Note" name="Note" value="<?php echo $edit->SPayment_notes; ?>" value="" class="form-control" />
			...
			<div class="form-group">
				...
				<label class="col-sm-1 control-label">:</label>
				<div class="col-sm-6">
					<input type="text" id="paidAmount" value="<?php echo $edit->SPayment_amount; ?>" name="paidAmount" value="0" class="form-control" />
