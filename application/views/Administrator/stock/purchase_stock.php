...
<div class="content_scroll" style="padding:120px 20px 25px 160px">
    ...
    <table class="border" cellspacing="0" cellpadding="0" width="70%">
        ...
        <h4><a style="cursor:pointer" onclick="window.open('<?php echo base_url();?>Administrator/reports/purchase_stock', 'newwindow', `width=${screen.width}, height=${screen.height}`); return false;"><img src="<?php echo base_url(); ?>images/printer.png" alt=""> Print</a></h4>
        <tr bgcolor="#89B03E">
            <th>Category</th>
            <th>ID</th>
            <th>Product Name</th>
